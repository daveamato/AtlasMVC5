...
namespace Atlas.Rename
{
    public class Program
    {
        private const String TemplateName = "Atlas";
        ...
        public static void Main()
        {
            ...
            for (Int32 i = 0; i < files.Length; i++)
            {
                    ...
                    extension == ".t4")
                {
                    ...
                    Regex assemblyVersion = new Regex("assembly: AssemblyVersion("0.1.0.0")]
                    Regex fileVersion = new Regex("assembly: AssemblyFileVersion("0.1.0.0")]
                    Regex copyright = new Regex("assembly: AssemblyCopyright("Copyright © Atlas Outdoor")]
                    Regex iisPort = new Regex("(<IISUrl>.*:)\\d+(.*</IISUrl>)");
                    Regex company = new Regex("assembly: AssemblyCompany("Atlas Outdoor")]
                    ...
                    content = company.Replace(content, "assembly: AssemblyCompany("Atlas Outdoor")]
                    ...
                    content = copyright.Replace(content, "assembly: AssemblyCopyright("Copyright © Atlas Outdoor")]
