...
namespace MvcTemplate.Tests.Unit.Components.Extensions
{
    ...
    {
        #region TreeFor<TModel>(this HtmlHelper<TModel> html, Expression<Func<TModel, MvcTree>> expression, Int32? hideDepth = null)

        [Fact]
        public void MvcTreeFor_Expression()
        {
        ...
        [Fact]
        public void MvcTreeFor_CollapsedExpression()
        {
            MvcTreeView tree = new MvcTreeView();
            tree.MvcTree.SelectedIds.Add(123456);
            tree.MvcTree.Nodes.Add(new MvcTreeNode("Test"));
