using Atlas.Controllers.Administration;
using System;
using System.Web.Mvc;
using System.Web.Routing;
using Xunit;

namespace Atlas.Tests.Unit.Controllers.Administration
{
    public class AdministrationAreaRegistrationTests
    {
        ...
        public void RegisterArea_MultilingualRoute()
        {
            ...
            Assert.Equal(new[] { "Atlas.Controllers.Administration" }, actual.DataTokens["Namespaces"] as String[]);
