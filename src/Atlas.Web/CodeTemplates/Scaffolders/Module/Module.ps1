...
$DataProject = "Atlas.Data"
$TestsProject = "Atlas.Tests"
$RazorViewProject = "Atlas.Web"
$ObjectsProject = "Atlas.Objects"
$ServiceProject = "Atlas.Services"
$ValidatorProject = "Atlas.Validators"
$ControllerProject = "Atlas.Controllers"
