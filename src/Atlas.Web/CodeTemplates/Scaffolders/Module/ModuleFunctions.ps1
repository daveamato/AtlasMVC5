Function Scaffold-CsTemplate([String]$Template, [String]$Project, [String]$OutputPath)
{
    ...
    $ControllerNamespace = "Atlas.Controllers"
    $ControllerTestsNamespace = "Atlas.Tests.Unit.Controllers"
    If ($Area) { $ControllerNamespace = "Atlas.Controllers.$Area" }
    If ($Area) { $ControllerTestsNamespace = "Atlas.Tests.Unit.Controllers.$Area" }
...
Function Scaffold-AreaRegistration([String]$Template, [String]$Project, [String]$OutputPath)
{
    if (!$Delete)
    {
        $ControllerNamespace = "Atlas.Controllers.$Area"
        $ControllerTestsNamespace = "Atlas.Tests.Unit.Controllers.$Area"
